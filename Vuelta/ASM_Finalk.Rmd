...
4. Taking a look at the AIC, we could justify the usage of a Generalized Linear Model, as long as the distribution chosen is the Gamma with the link function being the identity.
5. With the data we have at hand, visually speaking, the time is generally worsely predicted with the GLM Gaussian+identity with respect to the Linear Model, which seems to do better.
